// ===== クライアント側のエントリーポイント。出欠ボタン・コメント編集ボタンのイベント処理を定義、FetchAPIを用いてサーバーと非同期通信を行い、画面表示を動的に更新する =====
'use strict';

// ----- jQueryライブラリの読み込み -----　$で使えるようにしてDOM操作（要素取得・イベント設定など）を簡単にしている。
import $ from 'jquery';
// ----- Bootstrapの読み込み -----　Bootstrapのデザインが使えるようになる
